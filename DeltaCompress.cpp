                ...
                switch (config.quatPacker)
                {
                    ...
                    case QuatPacker::BitVector3ModifiedGaffer:
                    {
                            ...
                            )
                        {
                            ...
                            BitStream encoded;
                            bitsWritten += BitVector3ModifiedGafferEncode(
                                    toEncode,
                                    baseVec,
                                    (1 << RotationMaxBits) - 1,
                                    RangeBits{4, 5, 7},
...
//    }
    ...
    PRINT_INT(stats.quatDeltaPackedBitCount.count)
    PRINT_INT(stats.quatDeltaPackedBitCount.sum)
